...
/**
 * Helper for mod_articles_story
 *
 * @since  1.6
 */
abstract class ModArticlesStoryHelper
{
	/**
	...
	public static function getList(&$params)
	{
		...
		foreach ($items as &$item)
		{
			...
			if ($access || in_array($item->access, $authorised))
			{
				...
				$item->linkText = JText::_('MOD_ARTICLES_STORY_READMORE');
			}
			else
			{
				...
				$item->linkText = JText::_('MOD_ARTICLES_STORY_READMORE_REGISTER');
			}

			$item->introtext = JHtml::_('content.prepare', $item->introtext, '', 'mod_articles_story.content');
