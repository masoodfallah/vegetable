...
/**
 * Helper for mod_articles_BANNER
 *
 * @since  1.6
 */
abstract class ModArticlesBannerHelper
{
	/**
	...
	public static function getList(&$params)
	{
		...
		foreach ($items as &$item)
		{
			...
			if ($access || in_array($item->access, $authorised))
			{
				...
				$item->linkText = JText::_('MOD_ARTICLES_BANNER_READMORE');
			}
			else
			{
				...
				$item->linkText = JText::_('MOD_ARTICLES_BANNER_READMORE_REGISTER');
			}

			$item->introtext = JHtml::_('content.prepare', $item->introtext, '', 'mod_articles_Banner.content');
